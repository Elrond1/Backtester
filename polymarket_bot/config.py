...
# ── Множитель тренда предыдущего дня (WR 73.4% vs 67.5%) ────────────────────
# Если сигнал совпадает с направлением вчерашнего дня → ставка × множитель
TREND_MULTIPLIER = 2   # удвоить ставку при совпадении с трендом (+48% P&L)
